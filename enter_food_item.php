...
<body>
   ...
   <h2> Store New Food Item: </h2>
   
   <form method = "post" action = "http://localhost/GitHub/enter_food_item.php">
      <div class = "macros">
         <br>
         <p>Name of Food:</p>
	 ...
	 <p>Fat Per Serving:</p>
         ...
         <br><br><input type = "submit" name="enter_food" id="enter_food" value = "Store Food Item"></input><br><br>
     </div>
   </form>
        <button onclick="document.location='prj.php'">Return to Food Log</button>
